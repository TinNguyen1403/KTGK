  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Appbar.Header>
        ...
        />
        <Button textColor='black' buttonColor='#64B5F6' mode='contained' onPress={addJob} disabled={!isValid}>ADD</Button>
      </Appbar.Header>
      <FlatList
        style={{ flex: 1 }}
        data={jobs}
      ...
      <View style={styles.bottomContainer}>
        <Button textColor='black' buttonColor='#64B5F6' icon="logout" mode="contained" onPress={handleLogout}>
          Logout
        </Button>
      </View>
    </View>
